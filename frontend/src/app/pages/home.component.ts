  ...
  template: `
    ...
    <main class="home">
      ...
      <section class="stats-section">
        <div class="stats">
          <div class="stats__number">12348</div>
          <div class="stats__label">active creators... and counting!</div>
        </div>
      </section>
      ...
      <section class="testimonial-section">
        <div class="testimonial">
          <blockquote class="testimonial__quote">
            "Not Nice is the platform for connecting your brand with creators, globally and sets a new standard for content creation."
          </blockquote>
          <div class="testimonial__author">
            <strong>Fabian Frei</strong>
      ...
      <section class="final-cta-section">
        <h2 class="final-cta__title">Join the Not Nice way</h2>
...
export class HomeComponent {
  ...
  faqs = [
    ...
    { question: 'What if I have more questions? How can I contact Not Nice?', answer: 'You can reach us via email at hello@notnice.io or through WhatsApp for immediate assistance.', open: false }
  ];
